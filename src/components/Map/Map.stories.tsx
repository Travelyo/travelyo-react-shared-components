...
export const Primary: Story = {
  args: {
    ...
    hotel: {
        ...
        "description": "A lobby and a reception are available to guests. The upper floors are easily accessible using the lift. Services such as a cloakroom, a safe and currency exchange facilities make for a comfortable stay.",
        "rating": 5,
